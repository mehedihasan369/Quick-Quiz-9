        ...
        <Toast onClose={() => setShow(false)} show={show} delay={3000} autohide>
          ...
          <Toast.Body>{question.correctAnswer}</Toast.Body>
              ...
              
               {
                ...
                question.options.map(option => <Button id='xyz' onClick={() => optionToast()} variant="outline-dark w-100 m-1 fw-semibold "> {option} </Button>
                )
               }
               <Button onClick={() => optionToast()} variant="outline-dark w-100  m-1 fw-semibold "><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"  className="icon">
